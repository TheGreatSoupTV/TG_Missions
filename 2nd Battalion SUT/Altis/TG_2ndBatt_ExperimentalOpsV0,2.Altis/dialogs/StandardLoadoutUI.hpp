class StandardLoadoutUI
{
	...
	class controls
	{
		...
		class RscButton_1600: RscButton
		{
			...
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_ARAmmoBearer', player, false]";
		};
		class RscButton_1601: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_GrenadierAmmoBearer', player, false]";
		};
		class RscButton_1602: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_EngineerAmmoBearer', player, false]";
		};
		class RscButton_1603: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_MedAT', player, false]";
		};
		class RscButton_1604: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_MedATAmmoBearer', player, false]";
		};
		class RscButton_1605: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_Mortar_tube', player, false]";
		};
		class RscButton_1606: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_Mortar_bipod', player, false]";
		};
		class RscButton_1607: RscButton
		{
			idc = 1607;
			text = "Sniper (Urban)"; //--- ToDo: Localize;
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_Sniper', player, false]";
		};
		class RscButton_1608: RscButton
		{
			idc = 1608;
			text = "Spotter (Urban)"; //--- ToDo: Localize;
			x = 0.625 * safezoneW + safezoneX;
			y = 0.64 * safezoneH + safezoneY;
			w = 0.1625 * safezoneW;
			h = 0.06 * safezoneH;
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_Spotter', player, false]";
		};
		class RscButton_1609: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_AntiAir', player, false]";
		};
		class RscButton_1610: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['TG_fnc_AntiAirAmmoBearer', player, false]";
		};
