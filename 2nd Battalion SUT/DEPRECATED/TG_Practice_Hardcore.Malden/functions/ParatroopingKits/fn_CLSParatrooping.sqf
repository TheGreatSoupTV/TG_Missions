...
for "_i" from 1 to 6 do {player addItemToVest "ACE_atropine";};
...
for "_i" from 1 to 6 do {player addItemToVest "ACE_epinephrine";};
for "_i" from 1 to 6 do {player addItemToVest "ACE_morphine";};
