...
_ESCtext = 
		...
		(_display49 displayCtrl 120) ctrlSetText "TacticalGaming's Public Operations US-2. For more informations on Tactical Realism join us on www.TacticalGaming.net/HQ";
	;